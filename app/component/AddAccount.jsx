  ...
  const submitter = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        `${API}/addAccount/${data?.userid}/${data?.advid}`,
        formDataToSend
      );
    ...
    <>
      ...
      <div className="w-full flex flex-col gap-3 h-full p-5">
        ...
        <div>
          ...
          <span onClick={() => setLogin(!login)} className="font-semibold">
            Login
          </span>
        </div>
          ...
          <div className="grid sm:grid-cols-2 text-white gap-3 w-full">
            <div className="w-full relative h-16">
              <input
                ...
                className="py-1 transition-colors bg-transparent placeholder-black dark:placeholder-white h-10 peer outline-none focus:border-[#5c73db] focus:border-b-2 absolute top-0 left-0 duration-300 border-b-2 w-full"
              />
            </div>
            <div className="w-full relative h-16">
              <input
        ...
        <div
          onClick={submitter}
          className="bg-[#282828] text-white -mt-3 flex justify-center items-center rounded-md p-3 font-semibold"
        >
          Create
        </div>
      </div>
