...
const FetchWallet = ({ data, length }) => {
	return (
		<div
			className={`p-3 h-full ${length != 0 ? null : "pn:max-md:hidden"}`}
		>
			...
			<div className="h-[45vh] max-h-[330px] bg-white dark:bg-[#0D0D0D] border no-scrollbar rounded-b-2xl overflow-y-scroll no-scrollbar ">
				<Table>
