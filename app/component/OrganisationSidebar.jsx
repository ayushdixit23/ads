...
const OSidebar = () => {
	...
	return (
		<>
			...
			{
				pop && <div className="fixed inset-0 w-screen h-screen bg-black/60 backdrop-blur-md z-40 flex justify-center items-center">
          ...
          <input type="text" className="w-full py-2 pl-10 pr-4 text-gray-700 bg-white border rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring" placeholder="Search" />
				...
				<div className="flex flex-col justify-between flex-1 mt-8">
					<nav>
						<Link href={"/main/dashboard"} className={`flex items-center px-4 py-2 mt-5 ${path === "/main/dashboard" ? "bg-blue-600 text-white" : "text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"} transition-colors duration-300 transform rounded-md `}>
              ...
              <span className="mx-4 sm:max-md:hidden font-medium">Community</span>
						...
						<Link href="/main/ads" className={`flex items-center px-4 py-2 mt-5 ${path === "/main/ads" ? "bg-blue-600 text-white" : "text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"} transition-colors duration-300 transform rounded-md `} >
							{/* <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						{(fullname && image) && <div className={`flex items-center gap-1 px-4 py-2 mt-4 text-gray-600 ${open ? null : "transition-colors duration-300 transform"}  rounded-md dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700`} >
							...
							<span className=" sm:max-md:hidden font-medium">{fullname}</span>
						</div>}
						...
						<Link className={`flex items-center px-4 py-2  ${open ? null : "transition-colors duration-300 transform"} mt-5 ${path === "/main/wallet" ? "bg-blue-600 text-white" : "text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"}  rounded-md `} href="/main/wallet">
							<LuWallet2 />
              ...
              <span className="mx-4 font-medium">Tickets</span>
						...
						<Link className={`flex items-center px-4 py-2 mt-5 ${path.startsWith("/setting") ? "bg-blue-600 text-white" : "text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"}  ${open ? null : "transition-colors duration-300 transform"} rounded-md `} href={"/setting"}>
							<svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
