...
function page() {
  ...
  if (three.gender === "Men") {
    ...
    if (three.selectedAgeRange === "0-18") {
      AudiencebyAge = Math.ceil(totalMenAudience * (20 / 100));
    } else if (three.selectedAgeRange === "19-40") {
      AudiencebyAge = Math.ceil(totalMenAudience * (50 / 100));
    } else if (three.selectedAgeRange === "41-100") {
      AudiencebyAge = Math.ceil(totalMenAudience * (30 / 100));
    } else {
    ...
    if (three.selectedAgeRange === "0-18") {
      ...
      AudiencebyAge = Math.ceil(totalWomenAudience * (50 / 100));
    } else if (three.selectedAgeRange === "41-100") {
      AudiencebyAge = Math.ceil(totalWomenAudience * (30 / 100));
    } else {
    ...
    if (three.selectedAgeRange === "0-18") {
      ...
      AudiencebyAge = AudienceByGender * (50 / 100);
    } else if (three.selectedAgeRange === "41-100") {
      AudiencebyAge = totalAudience * (30 / 100);
    } else {
  ...
  const handleFileChanges = (e) => {
    ...
    if (file) {
      if (file.type.startsWith("image")) {
        ...
        alert(
          "Unsupported file type. Please select the appropriate file type."
        );
        e.target.value = "";
      }
    } else {
