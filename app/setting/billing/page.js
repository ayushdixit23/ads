...
const Page = () => {
  ...
  }, [advid, firstname, lastname, city, address, advertiserid, country, accounttype, taxinfo, userid])

  const handleSave = async () => {
    try {
      const res = await axios.post(`${API}/editadvertiser/${advid}`, {
