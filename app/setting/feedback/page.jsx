  ...
  return (
    <>
      <div className="h-full w-full p-[3%]">
        <h1 className="py-2 font-semibold text-2xl sm:text-3xl">Submit feedback</h1>
        ...
        <div className="flex flex-col gap-1">
          ...
          <textarea
            ...
            className="bg-[#222] rounded-2xl max-h-[80px] min-h-[70px] outline-none p-3"
            name="text"
            id="text"
            cols="10"
            rows="10"
        ...
        <div className="flex justify-end my-3 items-center">
          <div onClick={() => setMsg("")} className="bg-[#F1F2F3] mx-2 rounded-lg text-[#6B7280] p-2 px-4 font-medium">
            Cancel
          </div>
