  ...
  useEffect(() => {
    ...
    if (cookieData) {
      ...
      dispatch(
        setThree({
          postid,
          comid: parsedData?.communityId,
          isDisabled: true,
          Headline: parsedData.title,
          Description: parsedData.desc,
          media: url + parsedData.media[0].content,
          isImage: parsedData.media[0].type.startsWith("image") ? true : false,
        })
      );
        ...
        >
          {data?.communitywithDps.length > 0 ? (
            <div className="px-[2%] my-2 rounded-xl bg-maincolor pn:max-sm:px-2 pb-4">
              <div className="text-2xl font-semibold py-2 pn:max-sm:px-2 my-2">
                Community
              </div>
              <Select
                ...
                <SelectContent className="dark:text-white dark:bg-[#323b4e] dark:border-none ">
                  <SelectGroup className="max-h-[200px] gap-1 w-full flex flex-col justify-center items-center">
                    {data?.communitywithDps?.map((d, i) => (
                      <SelectItem value={d._id} key={i} className="">
                        {/* {console.log(d.dps)} */}
            ...
            <div>
              ...
              <div className="my-2 rounded-xl bg-maincolor pb-4 pn:max-sm:px-2">
                <div className="flex py-2 px-[2%] flex-col w-full">
                  ...
                  <input
                    value={three.communityName}
                    onChange={(e) =>
                      dispatch(setThree({ communityName: e.target.value }))
                    }
                    type="text"
                ...
                <div className="flex py-2 px-[2%] flex-col w-full">
                  ...
                  <textarea
                    value={three.communityDesc}
                    onChange={(e) =>
                      dispatch(setThree({ communityDesc: e.target.value }))
                    }
                    className="w-full border rounded-xl bg-transparent min-h-[150px] max-h-[300px] outline-none p-2"
                  ...
                  <div className="flex items-center justify-center w-full">
                    ...
                    >
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          dispatch(
                            setThree({ communityImage: e.target.files[0] })
                          )
                        }
                        type="file"
                        className="w-full hidden border rounded-xl bg-transparent outline-none p-2"
                        placeholder="Enter Community Name"
                      />
                    </label>
                  </div>
                ...
                >
                  ...
                  <SelectContent className="dark:text-white dark:bg-[#323b4e] outline-none dark:border-none ">
                    <SelectGroup className="max-h-[200px] gap-1 w-full flex flex-col justify-center items-center">
                      ...
                      <SelectItem value="Install Now">Install Now</SelectItem>
              ...
              <div className="flex w-full flex-col">
                ...
                <div className="flex justify-center  rounded-xl items-center border">
                  ...
                  <input
                    ...
                    id="link"
                    onChange={(e) =>
                      dispatch(setThree({ link: e.target.value }))
                    }
                    value={three.link}
                    type="text"
            ...
            {three.isDisabled === false && (
              <div className="my-3 mb-4 flex py-2 px-[2%] flex-col space-y-2">
                ...
                <div className="bg-[#F3F6F8] dark:bg-[#1e2129] dark:border dark:border-border flex sm:flex-row flex-col justify-between px-4 py-3 rounded-2xl items-center w-full">
                  <div
                    className="pn:max-sm:text-center pn:max-sm:w-[80%] 
                     pn:max-sm:py-2"
                  >
                    {three.type === "skipable" || three.type === "non-skipable"
                      ? "Videos must be MP4, AVI, or MOV, up to 5 mb"
                      : "Image must be JPG, PNG , JPEG , or SVG, up to 5 mb"}
                  </div>
          ...
          <div className="bg-[#FAFAFA] dark:bg-[#181a20] rounded-xl w-full flex justify-center items-center">
            <div className="bg-maincolor rounded-xl flex flex-col w-[85%] sm:w-[500px] text-wrap md:w-[370px]  my-10 px-2">
                ...
                <div className="flex items-center gap-2 pt-2 w-full">
                  <div>
                    {data?.communitywithDps.length > 0 ? (
                      ...
                      <img
                        src={URL.createObjectURL(three.communityImage)}
                        width={40}
                        height={30}
                        alt="commmunityImage"
                        className="min-w-[40px] min-h-[40px] rounded-xl h-[45px] w-[45px]"
              ...
              <div className="py-1 mt-2 font-semibold">
                {three?.Headline
                  ? three?.Headline?.length > 20
                    ? `${three?.Headline?.slice(0, 20)}...`
                    : three.Headline
                  : "Never have a bad meal"}
              </div>
              <div className="py-1">
                {three.Description != ""
                  ? three.Description?.length > 50
                    ? `${three?.Description?.slice(0, 50)}...`
                    : three.Description
