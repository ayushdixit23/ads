...
const Ad2 = ({
  ...
  return (
    <>
      ...
      <div className="flex justify-start dark:bg-[#181a20] bg-[#f1f1f1] w-full sm:fixed h-[87%] gap-9   pn:max-md:hidden">
        <div
          className={`${styles.customScrollbar} pn:max-md:hidden md:w-[900px] w-full overflow-y-scroll dark:bg-[#1e2129] bg-[#F0F2F5] py-5 px-2`}
        >
          ...
          <div className="bg-maincolor my-3 px-[2%] select-none py-2 rounded-xl ">
            ...
            <div className="text-sm text-black dark:text-white font-semibold">
              {three.type === "infeed" &&
                "Note: you found this at in the middle of the feed."}
              {three.type === "banner" &&
                "Note: you found this at in the top of the feed."}
              {three.type === "skipable" &&
                "Note: The video ads which can be skipable"}
              {three.type === "non-skipable" &&
                "Note: The video ads which cannot be skipable"}
            </div>
            ...
            <div className="py-3 px-[2%] rounded-t-xl bg-maincolor relative">
              ...
              <Select
                ...
                onValueChange={(selectValue) => {
                  const data = PointsCategory.find(
                    (d) => d.category === selectValue
                  );
                  ...
                  <SelectGroup className=" gap-1 w-full flex flex-col justify-center items-center">
                    <div className="max-h-[200px] w-full overflow-y-scroll no-scrollbar">
                      {PointsCategory?.map((d, i) => (
                        <SelectItem value={d.category} key={i} className="">
                  ...
                  onKeyPress={(e) => {
                    if (!t) return;
                      ...
                      if (e.key === "Enter") {
                        ...
                        // }));
                        dispatch(
                          setThree({ tags: [...three.tags, e.target.value] })
                        );
                        setT("");
                      }
                    } else {
          ...
          <div className="my-[1%] rounded-xl py-2 px-[2%] bg-maincolor">
            <h1 className="text-2xl font-semibold py-2">Target Audience</h1>
            ...
            <div>
                  ...
                  >
                    ...
                    <div
                      onClick={() => {
                        dispatch(
                          setThree({
                            location: three.location.filter((_, a) => a !== i),
                          })
                        );
                      }}
                    >
              ...
              {inputValue && (
                <div className="max-h-[300px] overflow-y-scroll border border-[#7d7c7c] p-3 rounded-xl no-scrollbar flex flex-col gap-2">
                  {myLocation.filter((l) =>
                            ...
                            onChange={(event) => {
                              ...
                              if (isChecked) {
                                if (three.location.length < 3) {
                                  dispatch(
                                    setThree({
                                      location: [...three.location, l?.name],
                                    })
                                  );
                                } else {
              ...
              <div className="text-[#5585FF] text-[13px] my-2">
                Note: Prices may fluctuate depending on factors such as traffic,
                weather conditions, events etc..
          ...
          <div className="my-[1%] rounded-xl py-3 px-[2%] bg-maincolor">
            <div>
              <h1 className="text-2xl font-semibold">Schedule and duration</h1>
              <div className="grid grid-cols-2 w-full gap-4 py-2">
                <div className="flex flex-col w-full">
                  <label htmlFor="sdate" className="text-lg font-semibold py-2">
                ...
                <div className={`${date ? "flex flex-col" : "hidden"}`}>
                  <label htmlFor="edate" className="text-lg font-semibold py-2">
                  ...
                  <input
                    ...
                    id="edate"
                    onChange={
                      (e) => dispatch(setThree({ endDate: e.target.value }))
                      // setThree({
                      // 	...three,
            ...
            <div className="flex flex-col gap-1">
              <div className="flex gap-2 my-2 items-center">
                ...
                <div className="flex flex-col">
                  <div className="font-medium">Run this ad Continuously</div>
                  <div>
      ...
      <div className="flex bg-maincolor flex-col md:hidden pb-[180px] py-2">
        <div className="grid grid-cols-1">
          ...
          <div className="w-full md:hidden bg-[#F0F2F5] dark:bg-[#181a20] my-4 rounded-2xl py-5 px-2">
            <h1 className="text-2xl font-semibold py-2 px-2">Select Target</h1>
